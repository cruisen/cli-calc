...
[![Known Vulnerabilities](https://snyk.io/test/github/cruisen/cli-calc/badge.svg)
...
* [mistune@0.8.4](https://app.snyk.io/org/cruisen/project/9ba152b5-1687-45c1-82ab-d85eadb74748)
  Introduced through: project@0.0.0 › m2r2@0.3.2 › mistune@0.8.4
  Fix: Pin mistune to version 2.0.1

[![Requirements Status](https://requires.io/github/cruisen/cli-calc/requirements.svg?branch=main)](https://requires.io/github/cruisen/cli-calc/requirements/?branch=main)

* [Issues](https://requires.io/github/cruisen/cli-calc/requirements/?branch=main)
  Too many dependencies. We try to update as good as possible.
